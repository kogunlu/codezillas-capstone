...
function Card4({btnClick}) {
  ...
  return (
    <div className='border border-solid border-gray-200 h-auto lg:h-96 w-5/6 px-10 py-5 flex flex-col justify-between items-start rounded-md shadow-xl flex-wrap'>
