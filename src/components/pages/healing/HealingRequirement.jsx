      ...
      <div className="h-full w-full flex flex-col justify-between items-center ">
        <div className="lg:flex lg:flex-row">
          <div className="w-full px-10 py-10 lg:w-4/6 lg:pl-20 xl:px-20 flex flex-col justify-evenly gap-2">
            <h1 className=" flex text-4xl allign-center lg:items-start font-medium 2xl:text-6xl my-8 ">
              WHY WORK WITH HEALING?
            </h1>
            <p className="text-gray-800 2xl:text-xl uppercase font-semibold">
              Reliable Income
            </p>
            <p className=" 2xl:text-xl text-lg text-gray-700 pb-8">
              {' '}
            ...
            <p className=" 2xl:text-xl text-lg text-gray-700 pb-16">
              {' '}
              No need to worry about costs from acquiring clients, billing,
              support or operations. Let us handle the fees and paperwork so you
              can focus on what you do best!
            ...
            <p className="text-gray-800 text-4xl uppercase font-semibold">
              Requirements
            </p>
            <ul className="list-disc list-inside text-black">
              <li className="2xl:text-xl text-lg text-gray-700">
