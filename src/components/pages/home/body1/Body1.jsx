                ...
                <div className="w-full grid grid-cols-12 grid-rows-6 absolute gap-y-10">
                    ...
                    <div className="grid row-span-5 col-span-5 col-start-4 md:col-start-1 ">
                        <div className="md:col-start-3">
                            ...
                            <br/>
                            <Button classList="py-2 px-5 hover:bg-cyan-200 bg-cyan-400 md:font-medium md:font-small rounded text-sm md:text-lg" function={()=>navigate('/book')} name="BOOK AN APPOINTMENT"/>
                        </div>
                    </div>
