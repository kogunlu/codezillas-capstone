...
<div>
<p className="w-full flex flex-col justify-between md:items-center lg:items-start px-5 py-5 lg:pb-10 lg:px-40 xl:px-52 2xl:px-80 text-xl font-medium my-2 ">Click Confirm To Use The Selected Card To Purchase 5 Tickets For 10$</p>
