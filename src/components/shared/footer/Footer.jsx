    ...
    <div className='w-full md:w-10/12 h-full flex flex-col md:flex-row justify-between items-center'>
      ...
      <div className='h-5/6 w-4/12 flex flex-col justify-evenly items-center'>
          <div className='w-full flex justify-between items-center '>
              ...
              <Link to='contact' className='text-gray-500 hover:scale-110 hover:underline hover:underline-offset-4 text-lg'>Contact</Link>
          </div>

          <div className='w-6/12 flex justify-around items-center'>
            <button type='button' alt="Twitter" className='text-3xl hover:text-cyan-400'><FaTwitter /></button>
            <button type='button' alt="Facebook" className='text-3xl hover:text-blue-800'><FaFacebook /></button>
            <button type='button' alt="Google" className='text-3xl hover:text-white'><GrGoogle /></button>
          </div>
      </div>
    </div>
